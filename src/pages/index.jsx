    ...
    <Parallax pages={5}>
      ...
      <Contact offset={4}>
        <Inner>
          ...
          <ContactText>
            Say <a href="mailto:edp.admin@meundies.com">Hi</a> or find me on
            other platforms:{' '}
            <a href="https://www.instagram.com/meundies/">Instagram</a>
          </ContactText>
        </Inner>
        <Footer>
          &copy; 2019 by MeUndies EDP.{' '}
          <a href="https://github.com/meundies/blog.meundies.dev">Github</a>.
          Made by <a href="https://www.meundies.com">MeUndies</a>.
        </Footer>
      </Contact>
    </Parallax>
  </>
